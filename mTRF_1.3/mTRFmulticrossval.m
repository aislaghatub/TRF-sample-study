function [r,p,mse,pred,model] = mTRFmulticrossval(stim,resp,resp1,resp2,fs,tmin,tmax,lambda1,lambda2)
...
%   P and the mean squared error MSE. The time lags T should be set in
...
%
%   [...,PRED,MODEL] = MTRFMULTICROSSVAL(...) also returns the predicted
%   outcomes PRED and the linear mapping function MODEL.
%
%   Inputs:
